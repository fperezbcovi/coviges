Find the naxos.pot file with default English language to translate to.
...
Download POEDIT software(https://poedit.net/) and to run it. Select from the menu 'File' > 'Create catalog from POT file...', open file from  '/naxos/languages/naxos.pot'.
