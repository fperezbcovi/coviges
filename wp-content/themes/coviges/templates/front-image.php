...
<?php
	$single_image = get_post_meta( get_the_ID( ), 'single-image', true );
...
<!-- Banner -->
<section id="home" class="banner image-bg <?php echo esc_attr( $css ); ?>"
	data-source="<?php echo esc_url( $single_image ); ?>"
>
